 ...
 */
public record Pt3Cell(int enabled, int note, int sample, int ornament, int volume, List<Pt3Command> commands) {

    public static final int KEEP = -1;
    public static final int OFF = 0;
    public static final int ON = 1;

    public static final Pt3Cell EMPTY = new Pt3Cell(KEEP, KEEP, KEEP, KEEP, KEEP, List.of());
