 ...
 */
public record PscCell(int enabled, int note, int sample, int ornament, int volume, List<PscCommand> commands) {

    public static final int KEEP = -1;
    public static final int OFF = 0;
    public static final int ON = 1;

    public static final PscCell EMPTY = new PscCell(KEEP, KEEP, KEEP, KEEP, KEEP, List.of());
